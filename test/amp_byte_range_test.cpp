...
SUITE(amp_byte_range)
{
    TEST(empty_range_with_item_count)
    {
        ...
        int retval = amp_byte_range_init_with_item_count(&range, &ia[0], 0, sizeof(ia[0]));
        CHECK_EQUAL(AMP_SUCCESS, retval);
        
        CHECK_EQUAL(AMP_TRUE, amp_byte_range_is_empty(&range));
    ...
    TEST(one_item_range_with_item_count)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init_with_item_count(&range, &ia[0], 1, sizeof(ia[0]));
        CHECK_EQUAL(AMP_SUCCESS, retval);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));
        
        CHECK_EQUAL(ia[0], *((int *)amp_byte_range_get_front(&range)));
        
        amp_byte_range_advance_front(&range);
    ...
    TEST(multiple_item_range_with_item_count)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init_with_item_count(&range, &ia[3], 3, sizeof(ia[0]));
        CHECK_EQUAL(AMP_SUCCESS, retval);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));
        
        CHECK_EQUAL(ia[3], *((int *)amp_byte_range_get_front(&range)));
        
        amp_byte_range_advance_front(&range);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));
        
        CHECK_EQUAL(ia[4], *((int *)amp_byte_range_get_front(&range)));
        
        amp_byte_range_advance_front(&range);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));
        
        CHECK_EQUAL(ia[5], *((int *)amp_byte_range_get_front(&range)));
    ...
    TEST(empty_range_without_end_gap)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init(&range, &ia[0], &ia[0], sizeof(int), sizeof(int));
        CHECK_EQUAL(AMP_SUCCESS, retval); 
    ...
    TEST(one_item_range_with_end_gap)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init(&range, &ia[0], ((AMP_BYTE *)&ia[1]) + 1, sizeof(int), sizeof(int));
        CHECK_EQUAL(AMP_SUCCESS, retval); 
    ...
    TEST(one_item_range_without_end_gap)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init(&range, &ia[0], &ia[1], sizeof(int), sizeof(int));
        CHECK_EQUAL(AMP_SUCCESS, retval); 
    ...
    TEST(multi_item_range_with_end_gap)
    {
        ...
        CHECK_EQUAL(ia[1], *((int *)amp_byte_range_get_front(&range)));
        
        amp_byte_range_advance_front(&range);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));  
        
        CHECK_EQUAL(ia[2], *((int *)amp_byte_range_get_front(&range)));
    ...
    TEST(multi_item_init_interleaved_with_end_gap)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init(&range, &array[0], (((AMP_BYTE *)&array[3]) + 3), sizeof(non_uniform), sizeof(int));
        CHECK_EQUAL(AMP_SUCCESS, retval);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));  
        
        CHECK_EQUAL(array[0].i, *((int *)amp_byte_range_get_front(&range)));
        
        amp_byte_range_advance_front(&range);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));  
        
        CHECK_EQUAL(array[1].i, *((int *)amp_byte_range_get_front(&range)));
        
        amp_byte_range_advance_front(&range);
        
        CHECK_EQUAL(AMP_FALSE, amp_byte_range_is_empty(&range));  
        
        CHECK_EQUAL(array[2].i, *((int *)amp_byte_range_get_front(&range)));
    ...
    TEST(multi_item_init_interleaved_without_end_gap)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init(&range, &array[0], &array[3], sizeof(non_uniform), sizeof(int));
        CHECK_EQUAL(AMP_SUCCESS, retval);
    ...
    TEST(empty_range_with_zero_step_with_end_gap)
    {
        ...
        struct amp_byte_range_s range;
        int retval = amp_byte_range_init(&range, 
                                         &array[0], 
                                         (((AMP_BYTE *)&array[0]) + 3), 
                                         0, 
                                         sizeof(int));
    ...
    TEST(multi_item_range_with_multi_step_with_end_gap)
    {
        ...
        CHECK_EQUAL(array[4].i, *((int *)amp_byte_range_get_front(&range)));
